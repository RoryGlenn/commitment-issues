 ...
 * node_modules/.bin tree. Unlike toolInvocation(), this deliberately has no
 * npx or PATH fallback: optional integrations must never download or execute a
 * global tool implicitly during a Git hook.
