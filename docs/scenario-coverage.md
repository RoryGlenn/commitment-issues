...
- **LIB-006** — project-local bin resolution walks ancestor `node_modules/.bin` directories while preserving argv and returning null instead of an implicit fallback. Unit: `test/process.test.mjs`.
