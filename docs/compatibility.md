...
| Registry upgrade or downgrade between releases | Not yet part of the supported matrix; tracked in [#96](https://github.com/RoryGlenn/commitment-issues/issues/96)                       |
